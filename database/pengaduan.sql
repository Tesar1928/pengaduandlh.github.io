...
(54, 7, 'pemungutan liar apa ?nbnbm', '<p>&nbsp;edit&nbsp;edit&nbsp;edit</p>', 6, '2020-04-17 21:33:23', '2');
...
(5, 'samplehalaman', 'sample-halaman', '<p>sdasd&nbsp; das&nbsp;</p>');
...
(1, 0, 3, 7, NULL, NULL, 'selesai', 'tinggi', 'pengaduan di ....', 'telah terjadi pemungutan liar di sda dasd as', 'Daftar_Relawan_(4).pdf', NULL, '2020-04-18 10:13:58', NULL, NULL, '1', '2020-04-18 11:21:31'),
(2, 1, 1, NULL, NULL, NULL, NULL, 'tinggi', NULL, 'ini ftal akan kami proses segera', 'linux-ransomware-decrypter-master.zip', '', '2020-04-18 11:10:51', NULL, NULL, '0', NULL),
...
(7, 0, 6, 7, NULL, NULL, 'buka', 'tinggi', 'cek', 'Ghhhhjffhhj', '1587271061022-909771980.jpg', NULL, '2020-04-19 11:38:34', NULL, NULL, '0', '2020-04-19 11:38:34'),
...
('address', 'Jawa Barat', NULL, 0),
('copyright', 'Dinas Lingkungan Hidup Kota Bekasi', '© All rights reserved.', 1),
...
('facebook', 'testing', NULL, 0),
('favicon', 'favicon.ico', NULL, 1),
('google_key', '', NULL, 0),
('google_secret_key', '', NULL, 0),
('home_banner_description', 'Aplikasi-Pengaduan merupakan langkah kami yang akan terus kami kembangkan demi profesional dan pesatnya era digital', NULL, 0),
('home_banner_title', 'Bekerja Profesional dan Terbuka dengan <font color=\"red\"><b>DLH-Pengaduan</b></font>', NULL, 0),
('instagram', 'testing', NULL, 0),
('language', 'english', 'english', 1),
('logo', 'dlh123_(1).png', NULL, 1),
('meta_description', 'Aplikasi pengaduan masyarakat', 'desc', 0),
('pagination_limit', '20', NULL, 0),
('phone', '123456789', '0', 0),
('support', '987654321', NULL, 0),
('support_email', '@gmail.com', NULL, 0),
...
('title', 'DLH-Pengaduan', 'I-Chef', 1),
('twitter', 'testing', NULL, 0),
('visitors', '87', '0', 0),
...
(1, 1, 'admin@gmail.com', 'admin', 'admin', 'admin', '10_2.jpg', '0192023a7bbd73250516f069df18b500', 100, 'pria', 'aktif', '2020-04-17 21:18:35'),
(3, 2, 'kalau@mail.com', 'kalau', 'sales', 'Saputra', 'IMG202004121313201.jpg', 'e10adc3949ba59abbe56e057f20f883e', 100, 'pria', 'aktif', '2020-04-18 09:44:22'),
...
--
ALTER TABLE `faqs`
  MODIFY `faq_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=55;
